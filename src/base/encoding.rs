...
impl SharedEncoding {
    ...
    pub fn get(&self) -> &'static Encoding {
        ...
        // This is safe, because the field can only be set to `&'static Encoding` pointers,
        // and these are guaranteed non-NULL, have unlimited lifetime, and unrestricted sharing.
        unsafe { &*encoding }
    }
